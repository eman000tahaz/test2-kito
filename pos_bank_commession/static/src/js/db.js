odoo.define('pos_driver.DB', function (require) {
"use strict";
...
var PosDB = core.Class.extend({
    ...
    init: function(options){
        ...
        this.driver_sorted = [];
        this.driver_by_id = {};
        this.driver_by_barcode = {};
        this.driver_search_string = "";
        this.driver_write_date = null;
    ...
    _driver_search_string: function(driver){
        var str =  partner.name;
        if(partner.barcode){
            str += '|' + partner.barcode;
        }
    ...
    get_driver_write_date: function(){
        return this.driver_write_date || "1970-01-01 00:00:00";
    },
    get_driver_by_id: function(id){
        return this.driver_by_id[id];
    },
    get_driver_by_barcode: function(barcode){
        return this.driver_by_barcode[barcode];
    },
    get_drivers_sorted: function(max_count){
        max_count = max_count ? Math.min(this.partner_sorted.length, max_count) : this.partner_sorted.length;
        var partners = [];
        for (var i = 0; i < max_count; i++) {
            partners.push(this.partner_by_id[this.partner_sorted[i]]);
